...
export const fetchImages = () => {
  return function(dispatch) {
    const choices = [
      ...
      {name:'apple', tags: ['apple', 'apples', 'fruit', 'red', 'green', 'food'], limit: 20},
      {name:'house', tags: ['house', 'home', 'building', 'homes', 'houses', 'buildings'], limit: 20},
      {name:'soda', tags: ['soda', 'drink', 'pop'], limit: 20},
      {name:'snow', tags: ['snow', 'cold', 'winter', 'ice', 'snowy'], limit: 20},
      {name:'milk', tags: ['milk', 'glass', 'cow', 'drink', 'white'], limit: 20},
